...
#-------------------------------------------------------------------
# 通过改函数 拿到 box_xy, box_wh, box_confidence, box_class_probs
#------------------------------------------------------------------
...
#---------------------------------------------------
#从train.txt 文件中读取出来的 长宽以及类别数 是无法直接计算loss 的
# 需要讲起映射成yolo head 的形式，才能与输出计算 loss
#--------------------------------------------------
...
#-----------------------------------------------------------
#yolo losss 计算 在model.compile(loss={}) 有使用
#-----------------------------------------------------------
